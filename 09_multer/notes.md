...
multer is a package used in file uploading in node js you can go to npmjs.com/packages/multer to read about it

let's summarize about multer below

to install multer package using npn
